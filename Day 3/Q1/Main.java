...
public class Main {
    public static void main(String[] args) {
        ...
        Passenger p1= new Passenger("P1001","Diya", "India");
        Passenger p2= new Passenger("P1002","Ram", "India");
        Passenger p3= new Passenger("P1003","Sam", "USA");
        Passenger p4= new Passenger("P1004","Adey", "Russia");
