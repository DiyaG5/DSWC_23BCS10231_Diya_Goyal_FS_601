...
class Order {
    ...
    public String toString() {
        return "Order ID: " + orderId + ", Trader: " + traderName + ", Price: $" + price + ", Quantity: " + quantity;
    }
}
...
public class Main {
    public static void main(String[] args) {
        ExchangeManager exchange =
                new ExchangeManager();
        Order o1 = new Order(101,"Alice", 65000.50,2);
        Order o2 =new Order(102,"Bob",65100.00,1);
        Order o3 =new Order(103,"Charlie",3500.25,5);
        Order o4 =new Order(104,"David",64950.75,3);
