...
class WebhookDispatcher implements ApplicationContextAware, SmartInitializingSingleton {
    ...
    public void afterSingletonsInstantiated() {
        ...
        System.out.println("Routing Table Ready. Total Integrations Loaded : "+ integrations.size()
        );
        integrations.forEach((beanName, bean) -> System.out.println(beanName + " -> "+ bean.getClass().getSimpleName())
        );
    }
}
